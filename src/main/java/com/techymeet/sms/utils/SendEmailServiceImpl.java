...
public class SendEmailServiceImpl implements SendEmailService {
	...
	@Override
	public String sendStudentRegisterEmail(String toaddress, String bodyContent, String subject, EmailModel model) {
	...
	public String getTemplate(String bodyContent, EmailModel model)
		...
		if (EmailCodes.STUDENT_REGISTRATION.equalsIgnoreCase(bodyContent)) {
			...
			boolean status = velocityEngine.mergeTemplate("/velocity/studentregistration.vm", "UTF-8", modelValue,
					finalTemplate);
			if (status) {
